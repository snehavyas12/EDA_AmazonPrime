...
The analysis makes use of libraries such as Pandas, NumPy, Matplotlib and Seaborn. The dataset includes two csv files names 'titles' (**9500+ titles**) and 'credits' (**124k+ credits**). It is mixed dataset with both numerical and categorical data. 

The project begins with overview of dataset, where we take a zoomed out look of the data such as dataset information, datatypes, variables and checking unique values and value counts of categorical column.
...
After that, duplicates are spotted and dropped from the dataset.
